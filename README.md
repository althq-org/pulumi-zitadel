...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `zitadel` with the `NAME` of your provider.
...
- binary: pulumi-resource-zitadel
  ...
  ignore: []
  ldflags:
  - -X github.com/althq-org/pulumi-zitadel/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-zitadel_darwin_amd64_v1
│   └── pulumi-resource-zitadel
├── pulumi-zitadel_darwin_arm64
│   └── pulumi-resource-zitadel
├── pulumi-zitadel_linux_amd64_v1
│   └── pulumi-resource-zitadel
├── pulumi-zitadel_linux_arm64
│   └── pulumi-resource-zitadel
├── pulumi-zitadel_windows_amd64_v1
│   └── pulumi-resource-zitadel.exe
└── pulumi-zitadel_windows_arm64
    └── pulumi-resource-zitadel.exe
```
