...
__all__ = ['IdpGithubArgs', 'IdpGithub']
...
class IdpGithub(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        github = zitadel.IdpGithub("github",
            client_id="86a165...",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param IdpGithubArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdpGithubArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdpGithubArgs.__new__(IdpGithubArgs)
        ...
        super(IdpGithub, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            is_linking_allowed: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'IdpGithub':
        """
        ...
        __props__ = _IdpGithubState.__new__(_IdpGithubState)
        ...
        __props__.__dict__["name"] = name
        __props__.__dict__["scopes"] = scopes
        return IdpGithub(resource_name, opts=opts, __props__=__props__)
