...
namespace Pulumi.Zitadel
{
    ...
    public partial class OrgIdpGoogle : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public OrgIdpGoogle(string name, OrgIdpGoogleArgs args, CustomResourceOptions? options = null)
            : base("zitadel:index/orgIdpGoogle:OrgIdpGoogle", name, args ?? new OrgIdpGoogleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrgIdpGoogle(string name, Input<string> id, OrgIdpGoogleState? state = null, CustomResourceOptions? options = null)
            : base("zitadel:index/orgIdpGoogle:OrgIdpGoogle", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrgIdpGoogle Get(string name, Input<string> id, OrgIdpGoogleState? state = null, CustomResourceOptions? options = null)
        {
            return new OrgIdpGoogle(name, id, state, options);
        }
    }

    public sealed class OrgIdpGoogleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// client id generated by the identity provider
        /// </summary>
        ...
        public OrgIdpGoogleArgs()
        {
        }
        public static new OrgIdpGoogleArgs Empty => new OrgIdpGoogleArgs();
    }

    public sealed class OrgIdpGoogleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// client id generated by the identity provider
        /// </summary>
        ...
        public OrgIdpGoogleState()
        {
        }
        public static new OrgIdpGoogleState Empty => new OrgIdpGoogleState();
    }
}
